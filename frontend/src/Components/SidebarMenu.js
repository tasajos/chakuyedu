...
const menuConfig = {
  ...
  estudiante: [
    ...
    { icon: FileText,    label: 'Exámenes y Tareas',    to: '/Estudiante/ExamenesyTareas/EstudianteTareas' },
    { icon: Award,       label: 'Certificados',         to: '/Estudiante/Certificados/EstudiantesCertificados' },
  ]
};
